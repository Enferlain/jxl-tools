(() => {
  ...
  const app = {
    ...
    els: {
      ...
      inputModeHeader: $(".input-mode-header"),
      ...
      btnLocalPickSource: $("#btn-local-pick-source"),
      btnLocalPickFiles: $("#btn-local-pick-files"),
      btnLocalPickTarget: $("#btn-local-pick-target"),
      btnLocalSelectionEdit: $("#btn-local-selection-edit"),
      btnLocalSelectionFiles: $("#btn-local-selection-files"),
      btnLocalRun: $("#btn-local-run"),
      localRecursive: $("#local-recursive"),
      localMirrorToggle: $("#local-mirror-toggle"),
      localSiblingToggle: $("#local-sibling-toggle"),
      localTargetPath: $("#local-target-path"),
      localSelectionTree: $("#local-selection-tree"),
      localBreakdown: $("#local-breakdown"),
      localTotalSize: $("#local-total-size"),
      localTotalFiles: $("#local-total-files"),
      localWorkbench: $(".local-workbench"),
      localPaneExplorer: $("#local-pane-explorer"),
      localPaneBreakdown: $("#local-pane-breakdown"),
      localResizerLeft: $("#local-resizer-left"),
      localResizerMiddle: $("#local-resizer-middle"),
      localDirectionBtns: $$("#local-direction-toggle .local-direction-btn"),
      localLosslessToggle: $("#local-lossless-toggle"),
      localQualitySlider: $("#local-quality-slider"),
      localQualityValue: $("#local-quality-value"),
      localEffortSlider: $("#local-effort-slider"),
      localEffortValue: $("#local-effort-value"),
      localPreserveMetadata: $("#local-preserve-metadata"),
      localJpegLossless: $("#local-jpeg-lossless"),
      localWorkersSlider: $("#local-workers-slider"),
      localWorkersValue: $("#local-workers-value"),
      localThreadsSlider: $("#local-threads-slider"),
      localThreadsValue: $("#local-threads-value"),
      dropZone: $("#drop-zone"),
